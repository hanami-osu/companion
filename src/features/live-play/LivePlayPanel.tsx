...
import type { LivePlay, NowPlaying, TosuConnection } from "../../lib/types";
...
export function LivePlayPanel({ beatmap, play, connection }: LivePlayPanelProps) {
    return (
        <section className="animate-content-in py-5" aria-labelledby="live-play-heading">
            <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1 pt-0.5">
                    ...
                    <h2
                        id="live-play-heading"
                        className="mt-2 truncate text-[17px] font-semibold tracking-tight text-zinc-50"
                    >
            ...
            <div
                ...
                aria-label={`${Math.round(play.progress * 100)}% complete`}
            >
                <div
                    className="h-full rounded-full bg-hanami transition-[width] duration-150"
                    style={{ width: `${play.progress * 100}%` }}
                />
            </div>
            ...
            <div className="mt-3 flex items-center justify-between text-xs">
                ...
                <span className="font-semibold text-zinc-200">
                    ...
                    {play.maximumPp != null && (
                        <span className="font-normal text-zinc-600"> / {Math.round(play.maximumPp)}</span>
                    )}
                </span>
            </div>
        </section>
