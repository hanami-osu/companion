export type TosuConnection = "disabled" | "searching" | "connecting" | "connected" | "stale" | "unavailable" | "error";
export type TosuMemoryAccess = "not_applicable" | "unknown" | "available" | "possibly_required" | "unavailable";
